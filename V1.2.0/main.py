...
class SerialApp:
    ...
    def getPorts(self):#選択肢を取得する処理節
        ...
        return [port.device for port in ports] if ports else ["COM12"]
    ...
    def parse_and_record(self, data):#ログの記述節ここを変えたらインプットの形変えれる
        try:
            dataList = ["ExpM", "AltM", "Pow", "Tempr", "Mnu", "FixType", "RTK", "Lat", "Lon", "Hae",
                "Yaw", "VelN", "VelE", "VelD", "Year", "Mon", "Day", "Hour", "Min", "Sec", "Msec",
                "RolD", "PitD", "TimeStmp"]
    ...
    def toggle_recording(self):
        if not self.is_recording:
            ...
            try:
                ...
                self.csv_writer.writerow(["ExpM", "AltM", "Pow", "Tempr", "Mnu", "FixType", "RTK", "Lat", "Lon", "Hae",
                    "Yaw", "VelN", "VelE", "VelD", "Year", "Mon", "Day", "Hour", "Min", "Sec", "Msec", "RolD", "PitD", "TimeStmp"
                ])
